...
public class MessageClientSetupParametersWithSendButtonAndTextEntry extends MessageClientSetupParameters implements Serializable{
    ...
    public MessageClientSetupParametersWithSendButtonAndTextEntry(String servername, String servername2, int numberOfRows, int numberOfColumns,boolean alignmentIsVertical,int numberOfWindows, int windowOfOwnText,boolean windowIsEnabled, boolean participantHasStatusWindow, String statusDisplay, boolean statusIsInRed, int rowsOfTextEntryArea){
