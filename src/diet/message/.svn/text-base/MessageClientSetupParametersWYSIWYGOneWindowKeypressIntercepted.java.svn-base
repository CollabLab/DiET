...
public class MessageClientSetupParametersWYSIWYGOneWindowKeypressIntercepted extends MessageClientSetupParameters implements Serializable{
    ...
    public MessageClientSetupParametersWYSIWYGOneWindowKeypressIntercepted(String servername, String servername2) {
        super(servername,servername2);

    }

    public MessageClientSetupParametersWYSIWYGOneWindowKeypressIntercepted(String servername, String servername2, int numberOfRows, int numberOfColumns,boolean alignmentIsVertical,boolean windowIsEnabled, boolean participantHasStatusWindow, String statusDisplay, boolean statusIsInRed){
       super (servername,servername2);
