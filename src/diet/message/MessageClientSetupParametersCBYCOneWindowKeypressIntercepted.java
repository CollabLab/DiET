...
public class MessageClientSetupParametersCBYCOneWindowKeypressIntercepted extends MessageClientSetupParameters implements Serializable{
   ...
   StyledDocumentStyleSettings wtsdsd;
    ...
    public MessageClientSetupParametersCBYCOneWindowKeypressIntercepted(String servername, String servername2) {
        super(servername,servername2);

    }

    public MessageClientSetupParametersCBYCOneWindowKeypressIntercepted(String servername, String servername2, int numberOfRows, 
            int numberOfColumns,boolean alignmentIsVertical,boolean windowIsEnabled, boolean participantHasStatusWindow, String statusDisplay, boolean statusIsInRed,
            StyledDocumentStyleSettings wtsdsd){
       super (servername,servername2);
    ...
    /*public long getTimeOfLastScrollDeprecated() {
        return timeOfLastScroll;
    }

    public void setTimeOfLastScrollDeprecated(long timeOfLastScroll) {
