...
public class MessageWYSIWYGTextSelectionFromClient extends Message implements Serializable {

    private int startIndex;
    private int finishIndex;

    public MessageWYSIWYGTextSelectionFromClient(String email, String username, int startIndex, int finishIndex) {
