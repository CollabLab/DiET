 ...
 * @author user
 */
public class JChatFrameSingleWindowWYSIWYGWithEnforcedTurntaking extends JChatFrame {
    ...
    WYSIWYGDocumentWithEnforcedTurntaking docII;
    
       

    

    public JChatFrameSingleWindowWYSIWYGWithEnforcedTurntaking(ClientEventHandler clevh, int numberOfRows, int numberOfColumns,boolean hasStatusWindow) {
        super(clevh);
          try {
            ...
            docII = new WYSIWYGDocumentWithEnforcedTurntaking(this);
            jTextArea.setDocument(docII);
                 ...
                 public void run(){
                       try{
                        ...
                        jTextArea.getDocument().removeDocumentListener(wDL);
                         ...
                         ((WYSIWYGDocumentWithEnforcedTurntaking)jTextArea.getDocument()).forceInsert(insrtIndex,text,null);
                 ...
                 public void run(){
                       try{
                        ...
                        jTextArea.getDocument().removeDocumentListener(wDL);
                         ...
                         //jTextArea.getDocument().remove(insrtIndex,length);
                         //jTextArea.append(text);
                         ((WYSIWYGDocumentWithEnforcedTurntaking)jTextArea.getDocument()).forceRemove(insrtIndex,length);
