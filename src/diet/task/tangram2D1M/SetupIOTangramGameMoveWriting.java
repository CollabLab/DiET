    ...
    private void saveMessageToFile(MessageTask mt){
        ...
        try{
           this.objOutTaskMessage.writeObject(mt);
            ...
            if(mt.getTimeStamp()!=null){
                line = line + mt.getTimeStamp().getTime()+"|";
            }
             else{
                line = line + "| |";
            }
            ...
            try{
               System.err.println("ERROR SAVING MESSAGE IN MAZEGAME: "+mt.getTimeStamp()+mt.getUsername()+mt.getMessageClass()+"  ");
