 ...
 * @author Arash
 */
public class TangramGameController extends TaskController{
    ...
    public TangramGameController(Conversation c, String experimentID){
        ...
        tangramLoader = new TangramLoader(System.getProperty("user.dir")+File.separator+"tangram_sets");//,c.getDirectoryNameContainingAllSavedExperimentalData().toString()
