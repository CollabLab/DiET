...
public class CCWITHINTURNINTERCEPTUHHREPLACE extends DefaultConversationController{
    ...
    public CCWITHINTURNINTERCEPTUHHREPLACE(){
    ...
    private synchronized void processLoopIntercept(){
    ...
    private void manipulateOutgoingQueue(MessageWYSIWYGDocumentSyncFromClientInsert mWYSIWYGkp){
       ...
       for(int i=0;i<taggedWords.size();i++){
           ...
           if(v3.size()!=0){
                ...
                Vector replacementIns = VectorToolkit.appendVector2ToVector1(vRepl,v);
