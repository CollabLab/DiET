...
public class CCGROOP3SEQ3BACKUP extends DefaultConversationController{
   
    AlphabeticalTask3WAY at = new AlphabeticalTask3WAY(null);
    ...
    public void participantJoinedConversation(Participant p) {
        ...
        c.displayNEWWebpage(p, "ID1", "Instructions", "", 490, 550, false,false);
    ...
    String interventionstage=istageEARLY;
