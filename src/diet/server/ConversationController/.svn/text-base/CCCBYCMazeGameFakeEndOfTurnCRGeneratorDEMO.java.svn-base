...
public class CCCBYCMazeGameFakeEndOfTurnCRGeneratorDEMO extends CCCBYCMazeGameFakeEndOfTurnCRGenerator{
...
///////////////////////////////////////////////////////////////////////////////
                   ...
                   if(intvcount %2 ==1) cr = this.cycCRIN_participant1.getNext(pRecipient);
                   intvcount++;
                   this.setState(1);
