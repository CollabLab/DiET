 ...
 * @author sre
 */
public class CCPICTURESTIMULI4 extends DefaultConversationController{
        ...
        try{
             ...
             if(i == this.matchercorrectFaceNumber){
                   // String remainingTrials = "You have "+this.numberOfTrainingTrials - (this.)
                     ...
                     c.changeWebpageTextAndColour(director, "ID1","Correct.\n Your score is "+sc.getScore(), "green", "white");
                     c.sendArtificialTurnToRecipient(director, "Correct.\n Your score is "+sc.getScore(), 0);
                     c.sendArtificialTurnToRecipient(matcher,  "Correct.\n Your score is "+sc.getScore(), 0);
    ...
    public void processLoop() {
        super.processLoop();
        if(mode==CCPICTURESTIMULI4.mode5TRAININGPHASE)c.resetFromIsTypingtoNormalChatAllAllowedParticipants(super.getIsTypingTimeOut());
    ...
    public void processChatText(Participant sender, MessageChatTextFromClient mct) {
        ...
        if(mode==CCPICTURESTIMULI4.mode5TRAININGPHASE&&mct.getText().startsWith("/")){
           this.processSelection(sender, mct.getText());
        }
        else if (mode==CCPICTURESTIMULI4.mode5TRAININGPHASE){
...
public synchronized void initiateTestPhaseDirector(final int startindex, final int numberoftrials, final int returnindex){
    ...
    Thread t = new Thread(){
        public void run(){
        mode=CCPICTURESTIMULI4.mode1TESTPHASE_DIRECTOR;
        ...
        mode=CCPICTURESTIMULI4.mode2TESTPHASE_POSTDIRECTOR_PREMATCHER;
...
public synchronized void initiateTestPhaseMatcher(final int startindex, final int numberoftrials, final int returnindex){
        ...
        mode=CCPICTURESTIMULI4.mode3TESTPHASE_MATCHER;
        ...
        mode = CCPICTURESTIMULI4.mode4POSTTESTPHASE;
...
public synchronized void singleDirectorTrial(int startIndex){
    ...
    String message3AfterTestPhaseWindow = "The test phase is finished. <br>"
     ...
     class Score{
         ...
         int success_increment =3;
         int unsuccess_decrement =1;
