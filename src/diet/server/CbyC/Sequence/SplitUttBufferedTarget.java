 ...
 * @author Greg
 */
public class SplitUttBufferedTarget extends Sequence {
    ...
    public SplitUttBufferedTarget(CCCBYCSplitUtterance cC,String actualSender,Sequences sS) {
  ...
  public synchronized Sequence addDocChange(DocChange dc){  
    ...
    public synchronized boolean haveCriteriaBeenMetForAbort(){
        ...
        if(!runCheckingThread)return true;
    ...
    public synchronized void abortDueToNewLine(){
        nlCount++;
    ...
    boolean closedDueToEnter = false; 
   ...
   public String getType(){
        String type ="";
        if (closedDueToEnter){
            type = "closedDueToEnter: "+nlCount+ "new lines";
        }
        if(this.targetCriteriaMet)return  type+ "Target..split generated "+debugOfAbort;
        return type+ "Target...ABORTED "+debugOfAbort; 
    }
