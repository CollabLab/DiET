...
public class Turn implements Serializable{
  ...
  private Vector additionalValues;
   ...
   public Turn(){
    ...
    public Turn (ConversationHistory cH,String type, long onset, long enter,Conversant sender, Conversant apparentSender,String text,
    ...
    public String getIOAdditionalValues(){
        ...
        try{
            for(int i=0;i<this.additionalValues.size();i++){
                ...
                returnval = returnval + "|"+ (String)additionalValues.elementAt(i);
            }
        }catch (Exception e){
            e.printStackTrace();
            return "|error";
