...
private void repaintmaze(){
 ...
 public void changeCurrentMaze(){
    int idx = mazes.indexOf(currentmaze);
    System.out.println("jefpaint1");
    if(idx+1<=mazes.size()){
       currentmaze = (Maze)mazes.elementAt(idx+1);
       System.out.println("jefpaint2");
       jLabel1.setText(idx+" of "+ (mazes.size()-1));
       jLabel1.repaint();
       jPanel2.changeMaze(currentmaze);
