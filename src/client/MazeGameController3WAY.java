 ...
 */
public class MazeGameController3WAY extends TaskController{
    ...
    public void participantJoinedConversation(Participant pJoined){
        ...
        sIO.saveClientMazesFromSetupNo(pDirectorMazes, pMatcher1Mazes, pMatcher2Mazes, "");
    }
    ...
    public void loadAndSendMazesToClients(){
        try{
          ...
          if(spr!=null){
              Vector v = sIO.getAllMazesFromExperimentDirectory3WAY(spr.getValue());
